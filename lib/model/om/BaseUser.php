...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	public function setFirmId($v)
	{
		...
		if ($this->firm_id !== $v || $this->isNew()) {
			$this->firm_id = $v;
			$this->modifiedColumns[] = UserPeer::FIRM_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->firm_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->profile = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aFirm !== null) {
				if (!$this->aFirm->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aFirm->getValidationFailures());
				}
			}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setFirmId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setName($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setProfile($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::FIRM_ID)) $criteria->add(UserPeer::FIRM_ID, $this->firm_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setFirmId($this->firm_id);
	...
	/**
	 * Declares an association between this object and a Firm object.
	 *
	 * @param      Firm $v
	 * @return     User The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setFirm(Firm $v = null)
	{
		if ($v === null) {
			$this->setFirmId(0);
		} else {
		...
		// If this object has already been added to the Firm object, it will not be re-added.
		if ($v !== null) {
			$v->addUser($this);
		}
	...
	/**
	 * Get the associated Firm object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     Firm The associated Firm object.
	 * @throws     PropelException
	 */
	public function getFirm(PropelPDO $con = null)
	{
		if ($this->aFirm === null && ($this->firm_id !== null)) {
			$this->aFirm = FirmPeer::retrieveByPk($this->firm_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aFirm->addUsers($this);
			 */
		}
		return $this->aFirm;
	}
