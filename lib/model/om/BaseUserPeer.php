...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FirmId', 'Name', 'Profile', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'firmId', 'name', 'profile', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FIRM_ID, self::NAME, self::PROFILE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'firm_id', 'name', 'profile', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FirmId' => 1, 'Name' => 2, 'Profile' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'firmId' => 1, 'name' => 2, 'profile' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FIRM_ID => 1, self::NAME => 2, self::PROFILE => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'firm_id' => 1, 'name' => 2, 'profile' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::FIRM_ID);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Firm table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinFirm(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(UserPeer::FIRM_ID, FirmPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of User objects pre-filled with their Firm objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinFirm(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = FirmPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = FirmPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					FirmPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
				
				// Add the $obj1 (User) to $obj2 (Firm)
				$obj2->addUser($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		FirmPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (FirmPeer::NUM_COLUMNS - FirmPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined Firm rows

			$key2 = FirmPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = FirmPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (User) to the collection in $obj2 (Firm)
				$obj2->addUser($obj1);
